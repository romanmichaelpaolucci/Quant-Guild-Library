...
<div style="margin-top: 1.7em; padding:0.5em; background: #282832; color: #70ffff; font-size:1.4em; border-radius:9px;">
    <strong>Expected Value (EV) per Game:</strong> 589.62<br>
    <span style="color:#3f7;">Win Probability:</span> 48.97% &nbsp; | &nbsp;
    <span style="color:#f77;">Loss Probability:</span> 50.43% &nbsp; | &nbsp;
    <span style="color:#bbb;">Tie Probability:</span> 0.60%
</div>
...
<div style="margin-top: 1.7em; padding:0.5em; background: #282832; color: #70ffff; font-size:1.4em; border-radius:9px;">
    <strong>Expected Value (EV) per Game:</strong> -101.11<br>
    <span style="color:#3f7;">Win Probability:</span> 48.26% &nbsp; | &nbsp;
    <span style="color:#f77;">Loss Probability:</span> 51.23% &nbsp; | &nbsp;
    <span style="color:#bbb;">Tie Probability:</span> 0.51%
</div>
...
<div style="margin-top: 1.7em; padding:0.5em; background: #282832; color: #70ffff; font-size:1.4em; border-radius:9px;">
    <strong>Expected Value (EV) per Game:</strong> 101.64<br>
    <span style="color:#3f7;">Win Probability:</span> 45.16% &nbsp; | &nbsp;
    <span style="color:#fc0;">Tie Probability:</span> 0.41% &nbsp; | &nbsp;
    <span style="color:#f77;">Loss/Fold Probability:</span> 54.43%
</div>
