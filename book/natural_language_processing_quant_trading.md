...
<style type="text/css">
#T_d223b_row0_col0, #T_d223b_row1_col0, #T_d223b_row2_col0, #T_d223b_row3_col0, #T_d223b_row4_col0, #T_d223b_row5_col0, #T_d223b_row6_col0, #T_d223b_row7_col0, #T_d223b_row8_col0, #T_d223b_row9_col0 {
  font-size: 14pt;
}
</style>
<table id="T_d223b">
  <thead>
    <tr>
      ...
      <th id="T_d223b_level0_col0" class="col_heading level0 col0" >Corpus (Tweets)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th id="T_d223b_level0_row0" class="row_heading level0 row0" >0</th>
      <td id="T_d223b_row0_col0" class="data row0 col0" >$BTC: To the moon or nah?</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row1" class="row_heading level0 row1" >1</th>
      <td id="T_d223b_row1_col0" class="data row1 col0" >News moving $AMZN right now! 🚨</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row2" class="row_heading level0 row2" >2</th>
      <td id="T_d223b_row2_col0" class="data row2 col0" >$NVDA: To the moon or nah?</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row3" class="row_heading level0 row3" >3</th>
      <td id="T_d223b_row3_col0" class="data row3 col0" >Should I hodl my $TSLA position?</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row4" class="row_heading level0 row4" >4</th>
      <td id="T_d223b_row4_col0" class="data row4 col0" >Anyone else watching $META options activity?</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row5" class="row_heading level0 row5" >5</th>
      <td id="T_d223b_row5_col0" class="data row5 col0" >Is now the time to short $MSFT?</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row6" class="row_heading level0 row6" >6</th>
      <td id="T_d223b_row6_col0" class="data row6 col0" >Should I hodl my $META position?</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row7" class="row_heading level0 row7" >7</th>
      <td id="T_d223b_row7_col0" class="data row7 col0" >Is now the time to short $GOOG?</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row8" class="row_heading level0 row8" >8</th>
      <td id="T_d223b_row8_col0" class="data row8 col0" >Watching $META closely after that announcement.</td>
    </tr>
    <tr>
      <th id="T_d223b_level0_row9" class="row_heading level0 row9" >9</th>
      <td id="T_d223b_row9_col0" class="data row9 col0" >Loaded up on $BTC, let's go!</td>
    </tr>
  </tbody>
</table>
...
```
    ...
    interactive(children=(FloatSlider(value=45.0, description='Angle θ° (doc 2 direction)', layout=Layout(height='…





    <function __main__.plot_doc_vectors(theta_deg)>
...
```
    ...
    Pairwise Cosine Similarities Between Documents:
      Cosine(doc 1, doc 2) = 0.577
      Cosine(doc 1, doc 3) = 0.000
      Cosine(doc 2, doc 3) = 0.577
...
```
    ...
    doc 1: (1, 0, 0) cosine with buy vector (0,0,1): 0.0000
    doc 2: (1, 1, 1) cosine with buy vector (0,0,1): 0.5774
    doc 3: (0, 1, 0) cosine with buy vector (0,0,1): 0.0000
...
```
    ...
    Tweet: Just read Apple's earnings call: despite CEO's optimism, the subtle language around supply chain delays and the lukewarm guidance for Q2 give me serious pause 🤔📉. Not as bullish as the headline suggests.
    VADER Sentiment: {'neg': 0.118, 'neu': 0.882, 'pos': 0.0, 'compound': -0.4854}
    
    
    Tweet: Wow! AAPL breaks through resistance and the CFO drops hints about bigger buybacks, while social sentiment explodes 🚀💰. This could be the setup for another legendary run!
    VADER Sentiment: {'neg': 0.0, 'neu': 0.856, 'pos': 0.144, 'compound': 0.658}
